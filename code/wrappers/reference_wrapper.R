...
write.table(assay,file = "/results/GDSC1/Expression.csv",sep = ",")
samples <- data@sample
...
write.table(cell_samples,"/results/GDSC1/Cell_Lines_Details.csv",sep = ",")
...
write.table(mutation,file = "/results/GDSC1/Mutations.csv",sep = ",")
...
write.table(new_drug_response_df,"/results/GDSC1/Drug_Response.csv",sep = ",")
